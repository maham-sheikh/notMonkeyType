...
const TimerCard = ({ duration, onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full flex justify-center items-start z-50">
      <div className="max-w-lg sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-4 mt-8 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-accent/40 to-accent transition duration-500 transform hover:scale-105">
